...
<head>
    ...
    {% block stylesheet %}
        <style>
            ...
            {% block colors %}
                --color-light-0: #FFF;
                --color-light-50: #bfd1ff;
                --color-light-100: #84a7ff;
                --color-light-200: #D9E0F4;
                ...
                --color-secondary-50: #F4FEFF;
                --color-secondary-100: #CAF8FC;
                --color-secondary-200: #ADF6FC;
                --color-secondary-300: #89F3FC;
                --color-secondary-400: #4FEDFA;
                --color-secondary-500: #24EDFD;
                --color-secondary-600: #0CD8E8;
                --color-secondary-700: #25E9F8;
                --color-secondary-800: #069DA8;
                --color-secondary-900: #05828B;
        ...
        {% with VERSION='VERSION'|get_context %}
            {% with href="/django_admin_tailwind/"|add:VERSION|add:'/css/base.css' %}
                <link rel="stylesheet" type="text/css"
                      href="{% if DAT_DEBUG %}{{ href }}{% else %}https://static.snoweb.fr{{ href }}{% endif %}">
            {% endwith %}
        {% endwith %}
    {% endblock %}
    {% comment %}
                                        ...
                                        <div class="ml-3 relative"
                                            ...
                                            <div>
                                                <button @click="dropdownUser = true"
                                                        type="button"
                                                        class="svg-trigger flex items-center justify-between"
                                                        id="user-menu-button"
                                                        aria-expanded="false"
                                                        aria-haspopup="true">
                                                    <span class="sr-only">Open user menu</span>
                                                    {% comment %}heroicons-user-small{% endcomment %}
                                                    <div class=" bg-light-800 dark:bg-dark-800 dark:bg-dark-800 flex text-sm rounded-full focus:outline-none">
                                                    ...
                                                    <span class="font-bold text-2xl ml-3">{{ user.get_short_name|default:user.get_username }}</span>
                                                </button>
                                            </div>
                                            ...
                                            <div x-description="Dropdown menu, show/hide based on menu state."
                                                ...
                                                {% block userlinks %}
                                                    ...
                                                    <a href="{% url 'admin:logout' %}"
                                                       class="block hover:bg-light-50 dark:hover:bg-dark-50 px-4 py-2 text-sm text-light-700 dark:text-dark-700"
                                                       role="menuitem"
                                                       tabindex="-1" id="user-menu-item-0">{% translate 'Log out' %}</a>
                                                {% endblock %}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="pt-6">
                    <div class="tracking-tight pl-2 sm:pl-6 lg:pl-8">
                        ...
                        {% block content_subtitle %}
                            {% if subtitle %}
                                <p class="text-lg inline">{{ subtitle }}</p>
                            {% endif %}
                        {% endblock %}
                    </div>
                </div>
